...
test_preparation : $(SRC_DIR)/preparation.c $(OBJ_DIR)/preparation.o 
	$(CC) $(CFLAGS) $(TEST_DIR)/test_preparation.c $(SRC_DIR)/preparation.c -o test_preparation $(LDFLAGS)
...
test_affichage : $(SRC_DIR)/affichage.c $(OBJ_DIR)/affichage.o $(SRC_DIR)/preparation.c $(OBJ_DIR)/preparation.o $(SRC_DIR)/gestion.c $(OBJ_DIR)/gestion.o 
	$(CC) $(CFLAGS) $(TEST_DIR)/test_affichage.c $(SRC_DIR)/affichage.c -o test_affichage $(LDFLAGS)
